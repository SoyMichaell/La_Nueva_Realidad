<div class="row">
    <div class="col-md-5">
        <div class="card card-registro">
            <div class="card-header">Registro de vinculados al proyecto LA NUEVA REALIDAD.</div>
            <div class="card-body">
              <form action="controller/persona.controlador.php" method="post">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="number" name="telefono__persona" id="telefono__persona" placeholder="Introduzca telefono..." value="<?php echo isset($_GET['id']) != '' ? $data_persona['telefono'] : '' ?>" required>
                    </div>
                  </div>
                  <!--Fin cajon-->
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input class="form-control w-100" type="password" name="contra__persona" id="contra__persona" value="<?php echo isset($_GET['id']) != '' ? $data_persona['contrasena'] : '' ?>" required>
                      <button id="btn__mostrar" onclick="mostrarPass()" type="button"><i class="fa fa-eye"></i></button>
                    </div>
                  </div>
                  <!--Fin cajon-->
                  <div class="tile-footer">
                      <button class="btn btn-primario" name="btnAccion" value="<?php echo isset($_GET['id']) != '' ? 'EditarAI' : 'RegistroAI' ?>" type="submit"><?php echo isset($_GET['id']) != '' ? 'Editar' : 'Guardar' ?></button>
                      <a class="btn btn-warning" href="listar_ai.php">Ver lista</a>
                  </div>
              </form>
            </div>
        </div>
